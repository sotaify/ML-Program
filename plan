第一周：绪论（介绍课程）
第二周：数据治理（讲授3学时，1学时课程翻转，学生讲LDA）
第三周：数据预处理，实验1周
第四周：分类（讲授3学时，1学时课程翻转，学生讲softmax）
第五周：分类，实验1周
第六周：集成学习（讲授3学时，1学时课程翻转，学生讲GBDT）
第七周：集成学习，实验1周
第八周：课堂翻转（逻辑回归，岭回归，LASSO，双聚类，麻雀算法，朴素贝叶斯，CART，MCMC）
第九周：聚类（讲授3学时，1学时课程翻转，学生讲自组织映射）
第十周：聚类，实验1周
第十一周：群智能（讲授3学时，1学时课程翻转，学生讲蜻蜓算法）
第十二周：群智能，实验1周
第十三周：强化学习（讲授3学时，1学时课程翻转，学生讲DQN）
...
3.1 Brief Introduction of Agglomerative (main idea & parameters)
3.2 Agglomerative for clustering with visualization (iris, tree plot by t-sne each iter)
3.3 Explore Agglomerative with different parameters (linkage, assessed by DBI with KM)
